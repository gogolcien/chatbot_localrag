...
const BASE_CONOCIMIENTO = [
    {
        ...
        resp: "Nuestras cuentas son en Santander y Banamex.,Deberá enviar comprobante de pago a tu agente especificando el folio de la reservación, así como el nombre del titular de la misma. El depósito o transferencia puede realizarlo en cualquiera de las cuentas a nombre de Corporation Travel S.A de C.V. que se listan a continuación [Santander: 1234567890] [Banamex: 0987654321]",
        url: null,
    },
    {
        id: 'comision',
    ...
    },
    {
        ...
        resp: "Nuestro horario de atención es de Lunes a Viernes de 9 de la mañana a 8 de la tarde, sábados y domingos de 9 a 5.",
        url: null
    },
    {
        id: 'contacto_ventas',
...
// Misma forma que un item de BASE_CONOCIMIENTO (resp/url/info): se disparan directo por botón.
const ITEMS_MENU = {
    facturacion: {
        id: 'facturacion',
        label: 'Facturación',
        resp: "Aquí tienes el acceso a nuestro portal de facturación electrónica,Recuerda que solo se puede facturar el mes en curso.",
    ...
    capacitacion: {
        id: 'capacitacion',
        label: 'Capacitación',
        resp: "Aquí tienes nuestro portal de capacitación, donde podrás mantenerte actualizado y fortalecer tus conocimientos como agente de viajes.",
        url: "https://backoffice.imacop.com.mx/backoffice/imacop/capacitaciones",
    ...
    guia: {
        ...
        // El flujo real (elegir destino y redirigir a la guía específica de ese destino)
        // vive en mostrarSelectorDestinoGuia() en brain.js. Este item solo aporta el label.
    },
    publicidad: {
        id: 'publicidad',
        label: 'Publicidad para tus clientes',
        resp: "Aquí tienes nuestra sección de publicidad, encontrarás un banco de promociones actualizadas que puedes descargar, personalizar con el logotipo de tu agencia y compartir libremente con tus clientes.",
...
const MENU_PRINCIPAL = [
    ...
    { id: 'cotizar', icono: '🏨', label: 'Cotizar precio de hoteles y circuitos', tipo: 'submenu_flujo', flujo: 'DESTINO', mensaje: '¡Vamos a armar tu viaje! ¿A qué destino te gustaría ir?', flujoLabel: 'Cotizar hotel', categoria: 'cotizar_faq' },
...
const AGENTES = {
    ian: {
        ...
        voz: 'male',
        avatar: {
            neutral: './assets/IAN.webm',
            hablar: './assets/IAN.webm',
            pensar: './assets/IAN.webm',
            exito: './assets/IAN.webm'
        }
    },
    mia: {
        nombre: 'Mia',
        ...
        voz: 'female',
        avatar: {
            neutral: './assets/MIA.webm',
            hablar: './assets/MIA.webm',
            pensar: './assets/MIA.webm',
            exito: './assets/MIA.webm'
        }
    }
};
