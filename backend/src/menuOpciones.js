 ...
 * poder decirle con precisión dónde hacer clic, e "icono": el mismo emoji de
 * la categoría de primer nivel a la que pertenece (MENU_PRINCIPAL), para
 * poder mostrarlo junto a la ruta en el frontend. El orden replica a propósito
 ...
 * botón real.
 * @returns {{id: string, label: string, ruta: string, icono: string, textoBusqueda: string}[]}
 */
